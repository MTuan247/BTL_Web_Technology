...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/slideshow.css">
...
<script src="${pageContext.request.contextPath}/assets/js/slideshow.js"></script>
