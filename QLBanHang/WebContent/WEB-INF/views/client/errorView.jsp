...
<head>
  <title>Đã có lỗi xảy ra | Error | eShop</title>
  <meta charset="UTF-8">
  <meta name="viewport"
...
<jsp:include page="_header.jsp"></jsp:include>
  ...
  <h2 class="notice">Oops! Đã có lỗi xảy ra!</h2>
  <img src="${pageContext.request.contextPath}/assets/image/error.svg" class="img-notice">
